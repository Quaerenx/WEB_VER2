...
public class MaintenanceServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("cards".equals(viewType)) {
            ...
            request.getRequestDispatcher("/maintenance/cards.jsp").forward(request, response);
            ...
            if (customerName != null && !customerName.isEmpty()) {
                ...
                request.getRequestDispatcher("/maintenance/history.jsp").forward(request, response);
            } else {
            ...
            request.getRequestDispatcher("/maintenance/add.jsp").forward(request, response);
