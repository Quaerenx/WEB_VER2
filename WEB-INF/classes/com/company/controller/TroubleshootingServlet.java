...
public class TroubleshootingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("list".equals(viewType)) {
            ...
            request.getRequestDispatcher("/troubleshooting/list.jsp").forward(request, response);
            ...
            request.getRequestDispatcher("/troubleshooting/add.jsp").forward(request, response);
            ...
            if (idParam != null && !idParam.isEmpty()) {
                try {
                    ...
                    if (troubleshooting != null) {
                        ...
                        request.getRequestDispatcher("/troubleshooting/view.jsp").forward(request, response);
                    } else {
            ...
            if (idParam != null && !idParam.isEmpty()) {
                try {
                    ...
                    if (troubleshooting != null) {
                        ...
                        request.getRequestDispatcher("/troubleshooting/edit.jsp").forward(request, response);
                    } else {
                        session.setAttribute("error", "해당 트러블 슈팅 정보를 찾을 수 없습니다.");
                        response.sendRedirect("troubleshooting?view=list");
                    }
