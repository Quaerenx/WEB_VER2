...
public class MeetingServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("list".equals(viewType)) {
            ...
            request.getRequestDispatcher("/meeting/list.jsp").forward(request, response);
            ...
            if (meetingIdStr != null && !meetingIdStr.isEmpty()) {
                try {
                    ...
                    if (meeting != null) {
                        ...
                        request.getRequestDispatcher("/meeting/view.jsp").forward(request, response);
                    } else {
            ...
            request.getRequestDispatcher("/meeting/write.jsp").forward(request, response);
                ...
                try {
                    ...
                    if (meeting != null) {
                        ...
                        if (meetingDAO.isAuthor(meetingId, user.getUserId())) {
                            ...
                            request.getRequestDispatcher("/meeting/edit.jsp").forward(request, response);
                        } else {
